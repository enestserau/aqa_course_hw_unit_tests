...
// 1
let keyWithFourChars = Object.keys(character).filter((characterKey) => characterKey.length === 4);
console.log(keyWithFourChars);

// 2
let stringValues = Object.values(character).filter((characterValue) => typeof characterValue === 'string');
